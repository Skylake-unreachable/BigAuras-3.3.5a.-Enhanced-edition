	...
	self.categories = {
		{
			...
			spells = {
				...
				[64804] = 100, -- Entrapment (Hunter's snake trap root) -- добавил рут от снейк трапы -- не работает
...
--Добавил сайленс после диспела Unstable Affliction					
				[31117] = 175,  -- Unstable Affliction Silence (after dispel)
				
				
				
--Добавил МС дебаффы	
				[47486] = 39,	-- Mortal Strike (warrior)
				[19434] = 39,  -- Aimed Shot (Hunter)
				[57975] = 39,  -- Wound Poison (Rogue)	
				
		

--Ниже добавил дизарм роги( дублирование!) 			
			    [51722] = 174,   -- [Rogue] Dismantrle				


				
--Ниже добавил интеррапты (не работают) !!!			
			    [6552] = 175,   -- [Warrior] Pummel
				[1766] = 175,   -- [Rogue] Kick
				[47528] = 175,  -- [DK] Mind Freeze
				[57994] = 175,  -- [Shaman] Wind Shear
				[19647] = 175,  -- [Warlock] Spell Lock
				[72] = 175,	  -- [Warrior] Shield Bash
				[132409] = 175, -- [Warlock] Spell Lock
				[2139] = 175,   -- [Mage] Counterspell
				[16979] = 175,  -- [Feral] Feral Charge (Bear)
...
--Добавил берсерк
                [18499] = 50, --Berserker Rage (warrior)				
--Добавил фирвард
				[6346] = 50, --Fear Ward (priest)
--Добавил тотем каменного когтя (абсорб тотем)				
				[55277] = 50, --Stoneclaw Totem (shaman)
--Добавил сакру пета хантера			
				[53480] = 50, --Roar of Sacrifice (hunter pet)
--Добавил фридом пета хантера
				[54216] = 50, --Master's Call (hunter pet)			
--Добавил интервен пета хантера
				[53476] = 50, --Intervene (hunter pet)
--Добавил мастер ауру холи паладина
				[31821] = 50, --Aura Mastery
--Добавил шв энха
				[30823] = 50, --Shamanistic Rage
--Добавил спринты энха
				[58875] = 50, --Spirit Walk (enh shaman)				
...
--Добавил реклу
[1719] = 50, --Recklessness (warrior)

--Добавил прок инстантного пиробласта фаер мага
[44445]   = 40, -- Fire mage instant pyroblast

--Добавил крылья паладина
[31884]   = 50, -- Avenging Wrath
				
				
				-- Disarms
--??? Не работают?				
				[53359] = 49, -- Chimera Shot - Scorpid
				[53543] = 49, -- Snatch (Bird of Prey)
				[64346] = 49, -- Fiery Payback
				[64058] = 49, -- Psychic Horror disarm
				[51722] = 49, -- Dismantle
				[676]   = 49, -- Disarm
...
--- Добавил сам				
				[10278] = 150, -- Hand of Protection
				[48792] = 150, -- Icebound Fortitude (DK anti-stun)
				[8178] = 150,  -- Grounding Totem Effect
			}
		},
		{
			name = "Roots",
...
--Интеррапты. Почему-то не работают		
		--[[
		{
			name = "Interrupts",
			priority = 170,
